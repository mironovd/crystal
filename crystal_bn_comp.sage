...
parser=argparse.ArgumentParser(description='Crystal calculations for B_n - comparison of combinatorial method and determinant method', prog='sage crystal_bn_comp.sage')
