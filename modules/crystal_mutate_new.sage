...
def mutate_node(I,js,C,w,node,badroot,t,accumulator,sinks,stats,bi_first_neg_allow):
    ...
    print("---")
    print("Working on monomial: ",node)
    print("  B_i: ",b)
    mm=1
#    print(bi_first_neg_allow)
#    if bi_first_neg_allow:
#        mm=2
    if len([kk for kk in b[mm:] if kk < 0])>0:
