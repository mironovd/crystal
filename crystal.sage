...
#        print("l",l)
#        print("R(w,l) ",r(w,l))
        for k in r(w,l): #range(1,N+1):
#            print("k",k)
#            print("m[k]",m[k])
#            print("k+ ",plus(w,l,k))

#            if plus(w,l,k)<oo: print("m[k+] ",m[plus(w,l,k)])
            if m[k]==1 and plus(w,l,k)<oo and m[plus(w,l,k)]==0:
                s=[]
                kmax=k
                tt=1
...
#                            print("t ",tt, " t- ", minus(w,l,tt))
                            result.append([l,node*Ainv(w,l,minus(w,l,tt))])
                else:
                    result.append([l,node*Ainv(w,l,k)])
            elif m[k] == 1 and plus(w,l,k)<oo and m[plus(w,l,k)] == 1 and pplus(w,l,k,2)<oo and m[pplus(w,l,k,2)]== -1:
                result.append([l, node*Ainv(w,l,k)])
                result.append([l, node*Ainv(w,l,plus(w,l,k))])
            elif m[k] == 2 and plus(w,l,k)<oo and m[plus(w,l,k)]== 1:
                tt=2
                while pplus(w,l,k,tt)<oo:
